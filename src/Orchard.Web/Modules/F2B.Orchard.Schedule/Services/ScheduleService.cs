...
using System.Text;
using F2B.Orchard.Schedule.Providers;
using F2B.Orchard.Schedule.Providers.ProviderFactories;
...
namespace F2B.Orchard.Schedule.Services
{
    ...
    public class ScheduleService : IScheduleService
    {
        ...
        public void RemoveScheduleItem(int id)
        {
            ...
            if (item.Has<SchedulePart>() && _services.Authorizer.Authorize(Permissions.DeleteContent, item))
            {
        ...
        public void RemoveFollowingDatesForScheduleItem(int id, DateTime date)
        {
            ...
            {
                if (_services.Authorizer.Authorize(Permissions.DeleteContent, item))
                {
