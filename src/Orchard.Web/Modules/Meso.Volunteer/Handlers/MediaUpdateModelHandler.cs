...
{
    public class MediaUpdateModelHandler : Orchard.Core.Common.Handlers.UpdateModelHandler, IMediaUpdateModelHandler
    {
        public MediaUpdateModelHandler(IDateLocalizationServices dateLocalizationServices) : base(dateLocalizationServices)
        {
        }
        ...
        IMediaUpdateModelHandler IMediaUpdateModelHandler.SetData(object _root)
        {
            base.SetData(_root);
            return this;
        }
